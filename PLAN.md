...
- Phase C is deliberately limited to deterministic reflection strengthening: same normalized content plus a strict support superset creates an immutable successor with unioned support. Changed-content reflections remain concurrently active; model-proposed correction/supersession is deferred. See `docs/REFLECTION_STRENGTHENING_ROADMAP_2026-08-27.md`. The 300/600/900 quality harness, semantic retirement, and disk/cache refinement remain later isolated milestones.
