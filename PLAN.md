...
- The next milestone is the **G3 design gate** for additive retired evidence and reflection strengthening/supersession semantics. No persistence version or observation retirement behavior should change until that design is reviewed and approved against Q2–Q6 of `docs/COMPACTION_QUALITY_ROADMAP_2026-08-25.md`.
