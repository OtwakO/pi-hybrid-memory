...
- The current milestone is a test-only deterministic 300/600/900-observation quality harness. It will measure required-fact retention, provenance, false retirement/retention, active-context reduction, structural validity, and report convergence without adding runtime behavior or provider calls. See `docs/MEMORY_QUALITY_HARNESS_ROADMAP_2026-08-27.md`. Semantic retirement and disk/cache refinement remain later isolated milestones.
